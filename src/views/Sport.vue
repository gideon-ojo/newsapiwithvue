    ...
    <div class="row">
      ...
      >
        <div class="bg-light position-relative h-100  mb-3">
          ...
          <img v-else-if="!sportnew.urlToImage" src="../assets/img/bimager.avif" class="w-100" alt="">
          ...
          <div class="p-2 ">
            ...
            <p class="text-dark  fs-6 fw-bold mt-0">{{ sportnew.title }}</p>
              ...
              <p class="text-dark w-100 pb-3" v-html="sportnew.description"></p> 
...
import axiosClient, { category } from "../axiosClient.js";
import { computed, onMounted, ref } from "vue";
import { useStore } from "vuex";
import Parallax from "../components/Parallax.vue";
const store = useStore()
/* console.log(store.state.sportnews) */
const sportnews = ref({});
const sportnew = ref([]);
...
onMounted(() => {
 axios
    .get(
      `https://newsapi.org/v2/top-headlines?country=us&category=sport&apiKey=03436138bcba4214a89cb998aebe798a`
    ) 
